...
export class DbStuctureInit1711734211443 implements MigrationInterface {
    name = 'DbStuctureInit1711734211443'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "contract_tx_histories" ("created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "id" SERIAL NOT NULL, "contract_id" integer NOT NULL, "tx_hash" character varying NOT NULL, "tx_type" "public"."contract_tx_histories_tx_type_enum" NOT NULL, CONSTRAINT "PK_db8f50f4bd78fb0746d4e4498d9" PRIMARY KEY ("id"))`);
