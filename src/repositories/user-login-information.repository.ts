...
export class UserLoginInformationRepository extends Repository<UserLoginInformation> {
  ...
  async findOneByAccessToken(accessToken: string): Promise<UserLoginInformation> {
    return await this.userLoginInformationRepository.findOne({
      where: {
  ...
  async findOneByRefreshToken(refreshToken: string): Promise<UserLoginInformation> {
    return await this.userLoginInformationRepository.findOne({
      where: {
